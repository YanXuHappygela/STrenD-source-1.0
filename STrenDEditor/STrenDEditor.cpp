...
STrenDEditor::STrenDEditor(QWidget * parent, Qt::WindowFlags flags)
...
//******************************************************************************
void STrenDEditor::closeEvent(QCloseEvent *event)
{
...
//******************************************************************************
void STrenDEditor::createStatusBar()
{
...
//********************************************************************************
void STrenDEditor::loadRotateFile()
{
...
//***********************************************************************************
void STrenDEditor::removeRows(void)
{
...
void STrenDEditor::addBlankRow(void)
{
	if( this->data->GetNumberOfRows() <= 0)
	{
		return;
...
void STrenDEditor::changeRowData(void)
{
	if( this->data->GetNumberOfRows() <= 0)
	{
		return;
...
void STrenDEditor::showStatistics(void)
{
	if( this->data->GetNumberOfRows() <= 0)
	{
		return;
	...
	STrenDEditor::statisticsToolbar->setTable(data, selection);
	this->flag = 1;	
}

void STrenDEditor::updateStatistics(void)
{
	if( this->data->GetNumberOfRows() <= 0)
	{
		return;
...
void STrenDEditor::STrenDAnalysisModel()
{
	if( spdkNNGWin)
	{
		delete spdkNNGWin;
